export default function Ptsd(){
    return `
      ...
      <h3>In the past month, have you: </h3>
        <ul class=form-list>
          <li>1. Had nightmares about the event(s) or thought about the event(s) when you did not want to?</li>
            <br>
            ...
            <br>
          <li>2. Tried hard not to think about the event(s) or went out of your way to avoid situations that reminded you of the event(s)?</li>
            <br>
            ...
            <label for="yes">Yes</label><br>
            <br>
          <li>3. Been constantly on guard, watchful, or easily startled?</li>
            <br>
            ...
            <label for="yes">Yes</label><br>
            <br>
          <li>4. Felt numb or detached from people, activities, or your surroundings?</li>
            <br>
            ...
            <label for="yes">Yes</label><br>
            <br>
          <li>5. Felt guilty or unable to stop blaming yourself or others for the events(s) or any problems the event(s) may have caused?</li>
            <br>
