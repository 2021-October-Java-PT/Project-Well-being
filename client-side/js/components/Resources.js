...
export default function Resources(){
    return `
        <div class="container-about">
            ...
            Mindfulness can therefore be a tool to avoid self-criticism and judgment while identifying and managing difficult emotions.</p>
            <button class="practice-mindfulness">Start Practicing Mindfulness</button>
            </div>
            <div class="resources_list">
                <br><hr><br>
                <h2 class="links-main-header">Or select from these quick links</h2>
