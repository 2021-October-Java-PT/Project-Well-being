...
export default function About(){
    ...
    <main class="bios">
        ...
        <section id="mattWelfley">
          ...
          <p class> I graduated from Kent State University in 2014 with a Bachelor of
          Arts in Organizational Communication. I've always enjoyed working with computers on the hardware side, now I enjoy working with the software just as much. While I am not next to a computer, I enjoy playing disc golf,
          rock climbing, and backpacking. I also enjoy working with
          ...
          <a id="linkedin" href="https://www.linkedin.com/in/matt-welfley">
            <img id="linkedin" src="${linkedInImg}" alt="linkedin" />
          </a>
        </section>
